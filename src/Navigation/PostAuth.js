...
const PreAuth = () => {
  ...
  return (
    <PostAuthDrawer.Navigator
      ...
      <PostAuthDrawer.Screen name={SCREEN_NAME.RouteName} component={RouteName} />

      <PostAuthDrawer.Screen name={SCREEN_NAME.DeliveryTeam} component={DeliveryTeam} />
      <PostAuthDrawer.Screen name={SCREEN_NAME.OrderPickupScan} component={OrderPickupScan} />
      <PostAuthDrawer.Screen name={SCREEN_NAME.AllOrders} component={AllOrders} />
      <PostAuthDrawer.Screen
        name={SCREEN_NAME.CameraScanner}
        component={CameraScanner}
        options={{ headerShown: false, swipeEnabled: false }}
      />
      <PostAuthDrawer.Screen name={SCREEN_NAME.RouteDetails} component={RouteDetails} />
      <PostAuthDrawer.Screen name={SCREEN_NAME.PharmacyChats} component={PharmacyChats} />
    </PostAuthDrawer.Navigator>
  );
};
