...
// const guidelineBaseWidth = 430;//360//411
// const guidelineBaseHeight = 1200;//686//683
...
const xdHeight = xdHeight => {
  const heightPercent = Math.round((xdHeight / 950) * 100);
...
const guidelineBaseWidth = 387;
const guidelineBaseHeight = 847;
