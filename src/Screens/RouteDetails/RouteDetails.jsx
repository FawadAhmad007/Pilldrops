...
const IconDataField = ({ name, icon, reg = false }) => {
    return (
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 2 }}>
            {icon}
            <Text style={[styles.orderId, !reg && styles.sairaCondensedRegular]}>
                {name}
            </Text>
        </View>
    );
                            ...
                            <View style={styles.headCardContainer}>
                                <View style={styles.headContainerStyle}>
                                    ...
                                    <View
                                        ...
                                        <IconDataField
                                            name={'(909) 000 9999 '}
                                            icon={<ICONS.TelephoneIcon color='white' />}
                                        />
                                        <IconDataField
                                            name={'(909) 000 9999 '}
                                            icon={<ICONS.LandlineIcon color='white' />}
                                        />
                                    </View>
                                    ...
                                    <View
                                        ...
                                        <IconDataField
                                            name={
                                                '24-07 94th street, first floor east elmhurst, Forest Hills'
                                            }
                                            icon={<ICONS.AddressIcon color='white' />}
                                        />
                    ...
                    <View style={styles.footer}>
                        ...
                        <View style={{ flexDirection: 'row', gap: 10 }}>
                            <ButtonPD
                                ...
                                routeDetail={true}
                                title={'Go Back'}
                                rightIcon={<ICONS.ChevronIcon />}
                                bgClr='black'
                            />
                            <ButtonPD
                                onPress={() =>
                                    navigation.navigate(Constants.SCREEN_NAME.RouteName)
                                }
                                routeDetail={true}
                                title={'Start Route'}
                                rightIcon={<ICONS.PaperPlaneIcon />}
                            />
                        </View>
                    </View>
                </View>
